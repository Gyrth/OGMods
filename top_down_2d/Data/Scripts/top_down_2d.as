...
void Init(string str){
	...
	LoadPalette();
	AddMusic("Data/Music/top_down_2d_music.xml");
	SetSong("Adventure");
}
...
void LoadPalette(bool use_defaults = false){
	...
	if(!data.parseFile("Data/Scripts/top_down_2d_default_palette.json")){
...
void GetAllSpawnerItems(){
	JSON file;
	file.parseFile("Data/Scripts/top_down_2d_assets.json");
	JSONValue root = file.getRoot();
