...
void Update(int num_frames) {
	...
	//Print("Label");
	//if(weapon_slots[primary_weapon_slot] != -1 && weapon_slots[secondary_weapon_slot] == -1 && label_primary == "bow"){
    //   SwapWeaponHands();
    //}
...
void ThrowWeapon() {
    if(weapon_slots[primary_weapon_slot] != -1){
        ...
        //if(target != -1){
            ...
            } else if(io.GetLabel() == "arrow" && throw_anim){
                io.SetThrownStraight();
            } else {
