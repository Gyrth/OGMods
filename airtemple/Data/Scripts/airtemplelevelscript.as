  ...
  if (moving == false){
    ...
    if(substr == "moveobj"){
      if(platenumber == platespusheddown){
        ...
        PlaySound("Data/Sound/concrete.wav", move);
  ...
  if (moving){
    ...
    if(dropdropdoor == true){
      ...
      if (playdropdoorsound == false){
        PlaySound("Data/Sound/dropdoor.wav", move);
    ...
    if(indimove == true){
      ...
      if (playdropdoorsound == false){
        PlaySound("Data/Sound/dropdoorindie.wav", move);
        playdropdoorsound = true;
      }
    }
    ...
    if(wolfheadbleeds == true && timewolfheadbleeds > 5.0){
      ...
      MakeParticle("Data/Particles/blooddrop.xml",io.GetPhysicsPosition(),vec3(0.0f,-1.0f,0.0f));
    }
  }
