		 ...
		 params.SetInt("ResearchGo", 1);
			...
			if(paramzz.GetInt("xp") > 0){
		  		if(params.GetInt("Researched") == 0 ){
					...
					level.SendMessage("displaytext \""+"Library: study an ancient scroll at this library and add +"+params.GetInt("researchAmount")+"% to your skill."+"\"");
		  		}else{
					level.SendMessage("displaytext \""+"There is no further knowledge to be gained from this library.");
