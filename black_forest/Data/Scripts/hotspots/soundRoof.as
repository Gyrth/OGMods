...
void SetParameters() {
	...
	if(level_params.GetInt("Rain") == 1){
		 params.SetString("Sound Path","Data/Sounds/rainRoof.wav");
	}else{
		 params.SetString("Sound Path","Data/Sounds/nothing.wav");
	}
   
    params.AddIntCheckbox("Global",false);
    params.AddIntCheckbox("Wind Scale",false);
    params.AddFloat("Fade Distance",3.0f);
