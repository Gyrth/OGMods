...
class Dialogue {
    ...
    void SetLanguage(string new_language_code){
        Log(info, "Setting the language to " + new_language_code);
            ...
            if(id != -1){
                ...
                if(!params.HasParam("NumParticipants") || !params.HasParam("Dialogue")){
                    ...
                    if(!params.HasParam("Script")){
                        ...
                        // Skip en since the default language is English.
                        if (language_code != "en" && FileExists(translated_path)){
                            dialogue_path = translated_path;
                        }

            			if(params.GetString("Dialogue") == "empty" || !LoadScriptFile(dialogue_path)) {
